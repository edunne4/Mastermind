...
public class MastermindModel {
    ...
    public static final int MIN_NUMBER_PEGS = 3;
    public static final int MAX_NUMBER_PEGS = 8;
    public static final int MIN_NUMBER_TURNS = 5;
    public static final int MAX_NUMBER_TURNS = 15;
